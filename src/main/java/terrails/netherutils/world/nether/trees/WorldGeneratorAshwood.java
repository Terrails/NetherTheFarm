...
public class WorldGeneratorAshwood extends WorldGenAbstractTree {

    public final IBlockState log;
    public final IBlockState leaves;
    public final IBlockState[] growBlock;

    public WorldGeneratorAshwood(boolean notify, IBlockState... replace) {
        super(notify);
        this.log = ModBlocks.LOG.getDefaultState().withProperty(BlockNTFLog.VARIANT, WoodType.ASH);
        this.leaves = ModBlocks.LEAVES.getDefaultState().withProperty(BlockNTFLeaf.VARIANT, WoodType.ASH);
        this.growBlock = replace;
    }

    public WorldGeneratorAshwood(boolean notify) {
        this(notify, Blocks.NETHERRACK.getDefaultState());
    }

    @ParametersAreNonnullByDefault
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        int i = rand.nextInt(3) + rand.nextInt(3) + 2 + rand.nextInt(2);
        boolean flag = true;
