...
public class BlockPortal extends BlockTileEntity<TileEntityPortalMaster> {
    ...
    public boolean canEntityDestroy(IBlockState state, IBlockAccess world, BlockPos pos, Entity entity) {
        if (entity instanceof EntityDragon) {
            return world.getBlockState(pos).getBlock() != ModBlocks.PORTAL_MASTER;
        }
    ...
    public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (!ConfigHandler.portalKeepInventory || !compound.hasKey("Inventory"))
            return;
    ...
    public void getDrops(@Nonnull NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, @Nonnull IBlockState state, int fortune) {
        ...
        if (!te.isInvEmpty() || !te.getSlavePos().equals(BlockPos.ORIGIN)) {
            ...
            if (ConfigHandler.portalKeepInventory && !te.isInvEmpty()) {
    ...
    @Override
    public void onBlockExploded(World world, @Nullable BlockPos pos, @Nullable Explosion explosion) {}
