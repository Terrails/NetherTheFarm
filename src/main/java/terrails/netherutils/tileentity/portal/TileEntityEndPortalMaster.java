...
public class TileEntityEndPortalMaster extends TileEntityBase implements ITickable, IPortalMaster {
    ...
    public TileEntityEndPortalMaster() {
        ...
        this.inventory = new ItemStackHandler(11) {
            ...
            protected void onContentsChanged(int slot) {
                TileEntityEndPortalMaster.this.markDirty();
            }
